...
CREATE INDEX IF NOT EXISTS idx_messages_sent_at ON public.global_messages(sent_at);
CREATE INDEX IF NOT EXISTS idx_messages_api_key ON public.global_messages(api_key);
CREATE INDEX IF NOT EXISTS idx_active_players_api_key ON public.active_players(api_key);
CREATE INDEX IF NOT EXISTS idx_active_players_user_id ON public.active_players(user_id);
CREATE INDEX IF NOT EXISTS idx_active_players_last_seen ON public.active_players(last_seen);
CREATE INDEX IF NOT EXISTS idx_script_executions_api_key ON public.script_executions(api_key);
CREATE INDEX IF NOT EXISTS idx_usage_history_user_id ON public.api_usage_history(user_id);
CREATE INDEX IF NOT EXISTS idx_execution_logs_user_id ON public.script_execution_logs(user_id);
